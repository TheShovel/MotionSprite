...
vm.extensionManager
  .loadExtensionURL(
    "https://extensions.penguinmod.com/extensions/ObviousAlexC/PenPlus.js",
  )
  .then(() => {
    console.log("loaded");
  });
/* generated l10n code */ Scratch.translate.setup({
  de: { "_Clipping & Blending": "Ränder verändern & Farben mischen" },
  fi: {
    "_Clipping & Blending": "Leikkaaminen ja sekoitus",
    _additive: "additiivista",
    _blending: "sekoitus",
    "_clear clipping box": "poista leikkauslaatikko",
    "_clipping box [PROP]": "leikkauslaatikon [PROP]",
    _default: "oletusarvoiseksi",
    _height: "korkeus",
    _invert: "käänteis",
    "_is additive blending on?": "onko additiivinen sekoitus päällä?",
    "_max x": "suurin x-sijainti",
    "_max y": "suurin y-sijainti",
    "_min x": "pienin x-sijainti",
    "_min y": "pienin y-sijainti",
    _multiply: "monistus",
    _off: "pois päältä",
    _on: "päälle",
    "_set clipping box x1:[X1] y1:[Y1] x2:[X2] y2:[Y2]":
      "aseta leikkauslaatikoksi x1: [X1] y1: [Y1] x2: [X2] y2: [Y2]",
    _subtract: "vähennys",
    "_turn additive blending [STATE]": "kytke additiivinen sekoitus [STATE]",
    "_use [BLENDMODE] blending": "käytä [BLENDMODE] sekoitusta",
    _width: "leveys",
  },
  it: {
    "_Clipping & Blending": "Ritaglio e Fusione",
    _height: "altezza",
    _off: "disabilita",
    _on: "abilita",
    _width: "larghezza",
  },
  ja: { _height: "高さ", _off: "オフ", _on: "オン", _width: "横幅" },
  ko: {
    "_Clipping & Blending": "클리핑 & 블랜딩",
    _default: "기본",
    _height: "높이",
    _width: "넓이",
  },
  nb: {
    "_Clipping & Blending": "Klipping og blanding",
    _height: "høyde",
    _off: "av",
    _on: "på",
    _width: "bredde",
  ...
  nl: {
    "_Clipping & Blending": "Knippen & mengen",
    _default: "standaard",
    _height: "hoogte",
    _invert: "omgekeerd",
    _off: "uit",
  ...
  ru: {
    "_Clipping & Blending": "Обрезка и Смешивание",
  ...
  tr: { "_Clipping & Blending": "Kırpma ve Karıştırma" },
  uk: { _height: "висота", _width: "ширина" },
  "zh-cn": {
    "_Clipping & Blending": "裁剪与颜色混合",
    _additive: "加法",
    _blending: "混合模式",
    "_clear clipping box": "清除裁剪框",
    "_clipping box [PROP]": "裁剪框[PROP]",
    _default: "默认类型",
    _height: "高度",
    _invert: "反色",
    "_is additive blending on?": "加法混合开启？",
    "_max x": "右x",
    "_max y": "上y",
    "_min x": "左x",
    "_min y": "下y",
    ...
    _on: "打开",
    "_set clipping box x1:[X1] y1:[Y1] x2:[X2] y2:[Y2]":
      "设置裁剪框 x1:[X1] y1:[Y1] x2:[X2] y2:[Y2]",
    _subtract: "差值",
    "_turn additive blending [STATE]": "加法混合 [STATE]",
    "_use [BLENDMODE] blending": "使用[BLENDMODE]混合模式",
    _width: "宽度",
  },
});
